...
public class Rosyjski {
    ...
    public static final String TEXT[] ={
            ...
            "Экспедиция состоится на следующий день после подтверждения.",//456
            "Откройте люк и идите спать, чтобы подать световой сигнал, если по радио попросили это сделать.",//457
            "Убедитесь, что вы в безопасности, когда подаёте световой сигнал.",//458
            "Вы можете установить будильник, чтобы кормить собаку ночью.",//459
            "Вы не можете войти в магазин в городе, если врач находится в вашем убежище.",//460
            "Вы можете ограбить магазин с помощью лома, когда врач находится в вашем убежище.",//461
            "Чтобы пользоваться дополнительными локациями вам сначала нужно нарисовать карту, нажав на значок с бумагой и карандашом.",//462
            ...
            "Чтобы получить золотой ключ надо пригласить в убежище повара, который встречается в лесу.",//465
            "Синий ключ можно купить в отеле.",//466
            "Вы можете перейти на страницу википедии, чтобы узнать подробную информацию и получение концовок.",//467
            "В подвале вы можете добывать уголь, кости и разные руды.",//468
            "Пейте пиво или сидр чтобы быстро возобновить энергию для работы в шахте.",//469
            ...
            "Там что-то сломано. Перегорело 3 предохранителя. Можете ли вы дать нам новый?", // 491
            "Крысы уничтожили несколько проводов. Для открытия ворот нам понадобится 6 новых проводов.", // 492
            ...
            "<клик>", // 499
            "<swipe>", // 500
            "Припасы - самое важное в выживании. Не забывайте следить за ними", // 501
            "Смахиванием пальца можно изменить комнату или некоторые места снаружи", // 502
            "Есть много других элементов, которые можно проверить касанием / щелчком.", // 503
            "Иди спать, чтобы получить следующий день", // 504
            "Давайте проверим состояние Боба. Нажмите на него и дайте ему выпить!", // 505
            "Важно следить за членами семьи. Ой, посмотри, растение ... убери его!", // 506
            "Некоторым действиям нужен сон, давайте посадим картошку и перейдем к следующему дню", // 507
            "Люк очень важен, если кто-то выбивает, он может быть врагом или помощником, у него тоже есть свое состояние", // 508
            "Вы можете рискнуть открыть люк или проверить, кто там находится, например, с помощью зелья", // 509
            "Создайте зелье: PissVision и выпейте его", // 510
            "Смотри! Помощники! Можете смело открывать люк", // 511
            "Пора накормить и напоить всех членов семьи", // 512
            "Полим картошку.", // 513
            "Важно вынести мусор. Иди в сад", // 514
            "Пора послать кого-нибудь в экспедицию за припасами. У нас есть карта, поехали в город", // 515
            "Проверьте радиацию, если она ВЫСОКАЯ, тогда экспедиция обойдется вам в один противогаз", // 516
            "Берем набор воды и еды", // 517
            "Хорошо, вы знаете основные вещи, теперь вы можете начать игру. Читайте дневник и используйте свой мозг! Убейте всех", // 518

            "Trash killer", // 519
            "В начале есть сильный яд для мусорных монстров.", //520

            "Слепой", // 521
            "Попробуйте поиграть без лампы.", // 522
